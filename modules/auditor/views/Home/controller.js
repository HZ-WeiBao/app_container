...
exports.viewUpdateMatchList = function(params) {
      ...
      func: function(rep) {
        ...
        if (result) {
          ...
          if(params.type === 'class'){
            ...
            var list = getDom_courseTable(rep);
...
function getDom_courseTable(rep){
